...
//compal end willy
		...
		snd_soc_write(codec, WM8903_VMID_CONTROL_0, reg);
//compal start willy
		snd_soc_write(codec, 0x39, 0x1b0);
		snd_soc_write(codec, 0x3a, 0x1b0);
		snd_soc_write(codec, 0x68, 0x10);
		snd_soc_write(codec, 0x2c, 0x85);
		snd_soc_write(codec, 0x2d, 0x85);
//compal end willy
		break;
