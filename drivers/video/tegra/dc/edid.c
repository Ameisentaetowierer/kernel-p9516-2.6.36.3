...
/* COMPAL - START - [2011/9/1 18:54] - Steve Yang - [HDMI]: Print out the EDID log */
/* EDID log is printed by tegra_edid_dump(), this function is wrapped around by 
   "#ifdef DEBUG", so "DEBUG" needs to be defined first to be able to run the function*/
#define DEBUG
/* COMPAL - END */
