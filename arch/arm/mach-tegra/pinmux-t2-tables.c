...
void tegra_pinmux_suspend(void)
{
    ...
    /* COMPAL - START - [2011/5/11  08:20] - Tec - [Power]: Set pin group to Tristate before suspend   */
    ...
    tegra_pinmux_set_tristate(TEGRA_PINGROUP_ATC, TEGRA_TRI_TRISTATE);
    /* COMPAL - END */
...
void tegra_pinmux_resume(void)
{
    ...
    /* COMPAL - START - [2011/5/11  08:20] - Tec - [Power]: Set pin group to Normal after resume   */
    ...
    tegra_pinmux_set_tristate(TEGRA_PINGROUP_ATC, TEGRA_TRI_NORMAL);
    /* COMPAL - END */
}
#endif
