...
static const struct tegra_emc_table ventana_emc_tables_elpida_300Mhz[] = {
	...
	},
	{
		...
		.regs = {
			...
			0x00000002,   /* REXT */
			0x00000002,   /* WDV */
			0x00000005,   /* QUSE  -DVFS NVbug 756635  */
			0x00000003,   /* QRST */
			0x00000008,   /* QSAFE */
			0x0000000b,   /* RDV */
			0x0000009f,   /* REFRESH */
			...
			0x00000002,   /* TCLKSTOP */
			0x000000d0,   /* TREFBW */
			0x00000004,   /* QUSE_EXTRA -DVFS NVbug 756635 */
			0x00000000,   /* FBIO_CFG6  -DVFS NVbug 756635 */
			0x00000000,   /* ODT_WRITE */
			0x00000000,   /* ODT_READ */
			0x00000082,   /* FBIO_CFG5 */
			0xa09404ae,   /* CFG_DIG_DLL  -DVFS NVbug 756635 */
			0x0001f000,   /* DLL_XFORM_DQS  -DVFS NVbug 756635 */
			0x00000000,   /* DLL_XFORM_QUSE  -DVFS NVbug 756635 */
			0x00000000,   /* ZCAL_REF_CNT */
	...
	},
	{
		...
		.regs = {
			...
			0x00000002,   /* WDV */
			0x00000005,   /* QUSE */
			0x00000003,   /* QRST  -DVFS NVbug 756635 */
			0x00000008,   /* QSAFE */
			0x0000000b,   /* RDV */
			0x000000ff,   /* REFRESH */
			0x00000000,   /* BURST_REFRESH_NUM */
	...
	},
	{
		...
		.regs = {
			...
			0x00000270,   /* TREFBW */
			0x00000004,   /* QUSE_EXTRA  -DVFS NVbug 756635  */
			0x00000001,   /* FBIO_CFG6  -DVFS NVbug 756635  */
			0x00000000,   /* ODT_WRITE */
			0x00000000,   /* ODT_READ */
			0x00000082,   /* FBIO_CFG5 */
			0xa06804ae,   /* CFG_DIG_DLL  -DVFS NVbug 756635  */
			0x007FD010,   /* DLL_XFORM_DQS  -DVFS NVbug 756635  */
			0x00000000,   /* DLL_XFORM_QUSE  -DVFS NVbug 756635 */
			0x00000000,   /* ZCAL_REF_CNT */
	...
	},
	{
		...
		.regs = {
			...
			0x00000003,   /* REXT */
			0x00000002,   /* WDV */
			0x00000006,   /* QUSE  -DVFS NVbug 756635  */
			0x00000003,   /* QRST */
			0x00000009,   /* QSAFE */
			0x0000000c,   /* RDV */
			0x0000045f,   /* REFRESH */
			...
			0x00000002,   /* TCLKSTOP */
			0x000004E1,   /* TREFBW */
			0x00000005,   /* QUSE_EXTRA  -DVFS NVbug 756635 */
			0x00000002,   /* FBIO_CFG6  -DVFS NVbug 756635  */
			0x00000000,   /* ODT_WRITE */
			0x00000000,   /* ODT_READ */
			0x00000282,   /* FBIO_CFG5 */
			0xE04E048B,   /* CFG_DIG_DLL  -DVFS NVbug 756635 */
			0x007fb010,   /* DLL_XFORM_DQS  -DVFS NVbug 756635 */
			0x00000000,   /* DLL_XFORM_QUSE  -DVFS NVbug 756635 */
			0x00000000,   /* ZCAL_REF_CNT */
...
static const struct tegra_emc_table ventana_emc_tables_hynix[] = {
              {
		...
		.regs = {
			...
			0x00000082,   /* FBIO_CFG5 */
			0xa09404ae,   /* CFG_DIG_DLL  -DVFS NVbug 756635 */
			0x007f8010,   /* DLL_XFORM_DQS  -DVFS NVbug 756635 */
			0x00000000,   /* DLL_XFORM_QUSE  -DVFS NVbug 756635 */
			0x00000000,   /* ZCAL_REF_CNT */
			0x00000005,   /* ZCAL_WAIT_CNT */
			0x00000000,   /* AUTO_CAL_INTERVAL */
	...
	},
	{
		...
		.regs = {
			...
			0x00000003,   /* WDV */
			0x00000006,   /* QUSE */
			0x00000005,   /* QRST  -DVFS NVbug 756635 */
			0x00000008,   /* QSAFE */
			0x0000000c,   /* RDV */
			0x000000ff,   /* REFRESH */
			0x00000000,   /* BURST_REFRESH_NUM */
			...
			0x00000082,   /* FBIO_CFG5 */
			0xa09404ae,   /* CFG_DIG_DLL  -DVFS NVbug 756635 */
			0x007f4010,   /* DLL_XFORM_DQS  -DVFS NVbug 756635 */
			0x00000000,   /* DLL_XFORM_QUSE  -DVFS NVbug 756635 */
			0x00000000,   /* ZCAL_REF_CNT */
			0x00000007,   /* ZCAL_WAIT_CNT */
			0x00000000,   /* AUTO_CAL_INTERVAL */
	...
	},
	{
		...
		.regs = {
			...
			0x00000082,   /* FBIO_CFG5 */
			0xa06804ae,   /* CFG_DIG_DLL  -DVFS NVbug 756635  */
			0x007FC010,   /* DLL_XFORM_DQS  -DVFS NVbug 756635  */
			0x00000000,   /* DLL_XFORM_QUSE  -DVFS NVbug 756635 */
			0x00000000,   /* ZCAL_REF_CNT */
			0x0000000e,   /* ZCAL_WAIT_CNT */
			0x00000000,   /* AUTO_CAL_INTERVAL */
